...
export default function ContactSection({ className }: ContactSectionProps) {
  ...
  return (
    <section
      id="contact"
      className={cn("section-padding py-16 md:py-24 bg-secondary", className)}
    >
      <div className="container mx-auto">
        <h2 className="text-3xl md:text-4xl text-center mb-4 font-serif reveal">
          Get In Touch
        </h2>
        <p className="text-center text-foreground/80 mb-8 md:mb-12 max-w-2xl mx-auto px-4 reveal">
          For casting inquiries, collaboration opportunities, or any other
          questions, please fill out the form below or reach out via social
          media.
        </p>
          ...
          <div className="flex flex-col space-y-6 justify-center reveal">
            ...
            <div>
              ...
              <div className="space-y-2">
                <p>
                  <strong>Talent Agency:</strong> Talent Fusion
                </p>
                <p>
                  <strong>Agent:</strong> Scott Allen Tucker
                </p>
                <p>
                  <strong>Email:</strong>{" "}
                  <a href="mailto:scott@talent-fusion.com">
                    scott@talent-fusion.com
                  </a>
                </p>
                <p>
                  <strong>Phone:</strong>{" "}
                  <a href="tel:7657484033">765-748-4033</a>,{" "}
                  <a href="tel:3179512230">317-951-2230</a>
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex space-x-4">
                <Button variant="outline" size="icon" asChild>
                  <a
                    href="https://instagram.com/vasudhakrishnamoorthy"
                    target="_blank"
                ...
                <Button variant="outline" size="icon" asChild>
                  <a
                    href="https://twitter.com/vasudhakrishna"
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label="Twitter"
                  >
                ...
                <Button variant="outline" size="icon" asChild>
                  <a
                    href="https://youtube.com/vasudhakrishna"
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label="YouTube"
                  >
